...
const Login = () => {
  ...
  return (
    <div className='Login'>
      ...
      <div className='container d-flex align-items-sm-center justify-contents-sm-center' style={{ 'backgroundColor': '#3dbee9', 'height': '350px', 'maxWidth': '30%', 'borderRadius': '10px', 'marginBottom': '30px' }}>
