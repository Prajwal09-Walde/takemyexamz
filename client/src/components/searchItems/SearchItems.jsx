...
const SearchItems = () => {
  ...
  return (
    <div className='searchItem'>
      <div className='searchItemContainer d-flex justify-content-sm-space-between' style={{ 'border': '1px solid #000000', 'height': '150px', 'padding': '10px', 'borderRadius': '10px', 'gap': '20px', 'marginBottom': '20px', 'marginLeft': '200px', 'maxWidth': '500px', 'marginTop': '30px', 'marginRight': '180px' }}>
